...
ActiveRecord::Schema.define(version: 2021_03_01_102313) do
  ...
  create_table "bookmarks", force: :cascade do |t|
    ...
    t.index ["user_id", "bookmarkable_id", "bookmarkable_type"], name: "unique_bookmarks", unique: true
  ...
  create_table "post_topics", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["post_id", "topic_id"], name: "index_post_topics_on_post_id_and_topic_id", unique: true
  ...
  create_table "votes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id", "voteable_id", "voteable_type"], name: "unique_votes", unique: true
